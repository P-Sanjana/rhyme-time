  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      characters.forEach((char) => {
        ...
        if (bgContext) {
          bgCanvas.width = measurements?.width ?? 0;
          bgCanvas.height = (measurements?.actualBoundingBoxAscent ?? 0) * 2.5;
          ...
          bgContext.fillText(
            char,
            bgCanvas.width / 2,
            measurements?.actualBoundingBoxAscent ?? 0
          );
