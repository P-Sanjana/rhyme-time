...
export default function RippleButton({
  ...
  return (
    <button
      ref={buttonRef}
      className={cn(
        'duration-[600ms] relative flex items-center justify-center overflow-hidden rounded-full bg-[#407c51] px-6 py-3 text-base font-semibold transition text-white',
        {
          'bg-[#ef9967]': isActive === true,
        }
      )}
      onMouseEnter={(e) => {
